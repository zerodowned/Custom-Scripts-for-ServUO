...
{
	public class AIOAnimalTrainer : BaseAIOVendor
	{
		private List<SBInfo> m_SBInfos = new List<SBInfo>();
		protected override List<SBInfo> SBInfos{ get { return m_SBInfos; } }

		[Constructable]
		public AIOAnimalTrainer() : base( "the animal trainer" )
		{
		...
		{
			private AIOAnimalTrainer m_Trainer;
			private Mobile m_From;

			public StableEntry( AIOAnimalTrainer trainer, Mobile from ) : base( 6126, 12 )
			{
				m_Trainer = trainer;
				m_From = from;
			}
		...
		private class ClaimListGump : Gump
		{
			...
			public ClaimListGump( AIOAnimalTrainer trainer, Mobile from, List<BaseCreature> list ) : base( 50, 50 )
			{
				m_Trainer = trainer;
				m_From = from;
				m_List = list;
		...
		private class ClaimAllEntry : ContextMenuEntry
		{
			...
			public ClaimAllEntry( AIOAnimalTrainer trainer, Mobile from ) : base( 6127, 12 )
			{
				m_Trainer = trainer;
				m_From = from;
			}
		...
		private class StableTarget : Target
		{
			...
			public StableTarget( AIOAnimalTrainer trainer ) : base( 12, false, TargetFlags.None )
			{
				m_Trainer = trainer;
			}
		...
		public AIOAnimalTrainer( Serial serial ) : base( serial )
		{
		}
