...
{
	public class AIORealEstateBroker : BaseAIOVendor
	{
		private List<SBInfo> m_SBInfos = new List<SBInfo>();
		protected override List<SBInfo> SBInfos{ get { return m_SBInfos; } }

		[Constructable]
		public AIORealEstateBroker() : base( "the real estate broker" )
		{
		...
		public AIORealEstateBroker( Serial serial ) : base( serial )
		{
		}
