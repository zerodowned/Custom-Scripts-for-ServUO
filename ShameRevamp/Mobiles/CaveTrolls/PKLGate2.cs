...
{
	public class PKLGate2 : Moongate
	{
	...
	//	public override int LabelNumber{ get{ return 1049498; } } // dark moongate
		...
		[Constructable]
		public PKLGate2() : this( false )
		{
		}

		[Constructable]
		public PKLGate2( bool decays, Point3D loc, Map map ) : this( decays )
		{
			MoveToWorld( loc, map );
		...
		[Constructable]
		public PKLGate2( bool decays ) : base( new Point3D( 5462, 26, -10 ), Map.Trammel )
		{
			Dispellable = false;
			ItemID = 0x4BCB;
			Hue = 1895;
		...
		public PKLGate2( Serial serial ) : base( serial )
		{
		}
