...
{
	public class PKLGate3 : Moongate
	{
	...
	//	public override int LabelNumber{ get{ return 1049498; } } // dark moongate
		...
		[Constructable]
		public PKLGate3() : this( false )
		{
		}

		[Constructable]
		public PKLGate3( bool decays, Point3D loc, Map map ) : this( decays )
		{
			MoveToWorld( loc, map );
		...
		[Constructable]
		public PKLGate3( bool decays ) : base( new Point3D( 5619, 46, 0 ), Map.Trammel )
		{
			Dispellable = false;
			ItemID = 0x4BCB;
			Hue = 1895;
		...
		public PKLGate3( Serial serial ) : base( serial )
		{
		}
