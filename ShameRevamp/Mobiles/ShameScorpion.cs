...
namespace Server.Mobiles
{
 ...
 public class ShameScorpion : BaseCreature
 {
  [Constructable]
  public ShameScorpion () : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
  {
   Name = "a scorpion";
   Body = 48;
   BaseSoundID = 397;
  ...
  public ShameScorpion ( Serial serial ) : base( serial )
  {
  }
