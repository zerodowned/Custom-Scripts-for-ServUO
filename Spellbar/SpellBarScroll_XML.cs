...
namespace Server.Engines.XmlSpawner2
{
    ...
    {	
		...
		public static void Initialize()
		{
			...
			CommandSystem.Register("PosGump", AccessLevel.GameMaster, new CommandEventHandler(PosGump_OnCommand));
		}
		...
		private static void EventSink_SetAbility(SetAbilityEventArgs e)
		{
			...
			if ( e.Mobile.HasGump(typeof (SpellBarGump.SpellBar_BarGump)) ) {
				e.Mobile.CloseGump( typeof( SpellBarGump.SpellBar_BarGump ) );
